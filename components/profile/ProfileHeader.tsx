...
export default function ProfileHeader({
  ...
  return (
    <div className="bg-[var(--instagram-card-background)] mb-6">
      ...
      {/* 데스크톱 레이아웃 */}
      <div className="hidden md:flex gap-8 lg:gap-12 py-8">
        {/* 프로필 이미지 */}
        <div className="flex-shrink-0 flex justify-start ml-8 lg:ml-12">
        ...
        {/* 프로필 정보 */}
        <div className="flex-1 space-y-5 mr-8 lg:mr-12">
          {/* 첫 번째 줄: 사용자명 및 액션 버튼 */}
